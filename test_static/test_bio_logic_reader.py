...
def test_bio_logic():
    ...
    with ManageTestReader(test_file.__str__(), 'bio_logic_080ecac4-8fa2-4c47-b7cc-4ef5db082b07') as reader:
        ...
        assert tables[0]['metadata'] == {"___TABLE_NAME__": "/", "settings.technique": "GCPL",
                                         ...
                                         "params.Set I/C.1": "UNKNWON", "params.Set I/C.2": "UNKNWON",
                                         ...
                                         "params.nc cycles.2": "0", "unit.data_vars.time": "s",
                                         "unit.data_vars.time_std_err": "s", "unit.data_vars.dq": "mA\u00b7h",
                                         "unit.data_vars.dq_std_err": "mA\u00b7h", "unit.data_vars.(Q-Qo)": "mA\u00b7h",
                                         "unit.data_vars.(Q-Qo)_std_err": "mA\u00b7h", "unit.data_vars.Ewe": "V",
                                         "unit.data_vars.Ewe_std_err": "V",
                                         "unit.data_vars.Q charge or discharge": "mA\u00b7h",
                                         "unit.data_vars.Q charge or discharge_std_err": "mA\u00b7h",
                                         "unit.data_vars.control_V": "V", "unit.data_vars.control_V_std_err": "V",
                                         "rows": "16154", "columns": "22"}
