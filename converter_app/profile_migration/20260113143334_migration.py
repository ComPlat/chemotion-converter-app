...
class ProfileMigrationScript(ProfileMigration):
    ...
    - For migratable profiles:
      ...
      - Sets a loop type to table-header–driven ("theader").
      - Normalizes detector-related metadata identifiers.
      - Auto-generates per-detector metadata identifiers (DECT1 – DECT5) for common SEC keys.
