...
global_res_path = os.path.abspath(os.path.join(parent_dir, 'test_files/ConverterAutoResults'))
global_src_path = os.path.abspath(os.path.join(parent_dir, 'test_files/ChemConverter'))
